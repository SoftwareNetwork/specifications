...
{
    auto &s = sln.addDirectory("demo.emweb");
    auto &p = s.addProject("wt", "4.0.1");
    p.Source = Git("https://github.com/emweb/wt", "{v}");
    ...
    wt.Public += "pub.cppan2.demo.boost.multi_index-1"_dep;
    wt.Public += "pub.cppan2.demo.boost.asio-1"_dep;
    wt.Public += "pub.cppan2.demo.boost.date_time-1"_dep;
    wt.Public += "pub.cppan2.demo.boost.filesystem-1"_dep;
    wt.Public += "pub.cppan2.demo.boost.ublas-1"_dep;
    wt.Public += "pub.cppan2.demo.gnome.pango.pangoft2-1"_dep;
    wt.Public += "pub.cppan2.demo.boost.numeric-1"_dep;
    wt.Public += "pub.cppan2.demo.boost.thread-1"_dep;
    wt.Public += "pub.cppan2.demo.glew-2"_dep;
    wt.Public += "pub.cppan2.demo.graphicsmagick.magick-1"_dep;
    wt.Public += "pub.cppan2.demo.libharu-2"_dep;
    wt.Public += "pub.cppan2.demo.openssl.ssl-1"_dep;
    ...
    http.Public += "pub.cppan2.demo.boost.program_options-1"_dep;
    http.Public += "pub.cppan2.demo.boost.spirit-1"_dep;
    http.Public += "pub.cppan2.demo.madler.zlib-1"_dep;
    http.Public += wt;
    ...
    sqlite3.Public += dbo;
    sqlite3.Public += "pub.cppan2.demo.sqlite3-3"_dep;
}
