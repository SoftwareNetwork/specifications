...
{
    auto &p = s.addProject("google.grpc", "1.83.0");
    ...
    // core
    {
        ...
        t -= "src/core/call/metadata_channelz.cc";
...
thread_local absl::BitGen SharedBitGen::bit_gen_ = [](){
    ...
    return absl::BitGen{};
        ...
        t.patch("src/core/credentials/transport/tls/grpc_tls_crl_provider.cc", "X509_NAME* issuer", "auto issuer");
    }
    ...
    auto &core_tsi = p.addStaticLibrary("core.tsi");
    {
        ...
        t.patch("src/core/tsi/ssl_transport_security_utils.cc", "X509_NAME* cert_issuer_name", "auto cert_issuer_name");
        t.patch("src/core/tsi/ssl_transport_security_utils.cc", "X509_NAME* crl_issuer_name", "auto crl_issuer_name");
        t.patch("src/core/tsi/ssl_transport_security_utils.cc", "X509_NAME* issuer", "auto issuer");
        t.patch("src/core/tsi/ssl_transport_security_utils.cc", "ASN1_OCTET_STRING* akid", "const ASN1_OCTET_STRING * akid");
        t.patch("src/core/tsi/ssl_transport_security.cc", "X509_NAME* subject_name", "auto subject_name");
        t.patch("src/core/tsi/ssl_transport_security.cc", "X509_NAME_ENTRY* common_name_entry", "const X509_NAME_ENTRY * common_name_entry");
        t.patch("src/core/tsi/ssl_transport_security.cc", "ASN1_STRING* common_name_asn1", "const ASN1_STRING * common_name_asn1");
        t.patch("src/core/tsi/ssl_transport_security.cc", "root_name = X509_get_subject_name(root);", "root_name = (X509_NAME*)X509_get_subject_name(root);");
        t.pushFrontToFileOnce("src/core/tsi/ssl_transport_security.cc", "#include <crypto/asn1.h>");
    }
