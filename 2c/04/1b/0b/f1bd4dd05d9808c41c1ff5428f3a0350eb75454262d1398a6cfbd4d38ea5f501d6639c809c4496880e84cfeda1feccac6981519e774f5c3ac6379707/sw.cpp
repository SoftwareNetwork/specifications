...
{
    auto &sdk = s.addProject("amazon.aws.sdk", "1.9.123");
    ...
    add_target_with_core("sqs");
    add_target_with_core("textract");
    add_target_with_core("location") += "AWS_LOCATIONSERVICE_EXPORTS"_def;
