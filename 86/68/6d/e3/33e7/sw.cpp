void build(Solution &sln)
{
    ...
    auto &libcurl = s.addTarget<LibraryTarget>("badger.curl.libcurl", "7.56.1");
    libcurl.Source = Git("https://github.com/curl/curl", "curl-{M}_{m}_{p}");
    ...
    libcurl.Public += "pub.cppan2.demo.c_ares-1"_dep;
    libcurl.Public += "pub.cppan2.demo.gnu.gss-1"_dep;
    libcurl.Public += "pub.cppan2.demo.nghttp2-1"_dep;
    libcurl.Public += "pub.cppan2.demo.libssh2-1"_dep;
    libcurl.Public += "pub.cppan2.demo.madler.zlib-1"_dep;
    ...
    if (libcurl.Variables["CURL_TYPEOF_CURL_OFF_T"] != "0")
    {
    ...
    if (libcurl.Variables["HAVE_LONG_LONG"] != "0")
    {
        libcurl.Variables["HAVE_LONGLONG"] = "1";
        libcurl.Variables["HAVE_LL"] = "1";
    }

    if (libcurl.Variables["HAVE_SOCKLEN_T"] != "0")
    {
