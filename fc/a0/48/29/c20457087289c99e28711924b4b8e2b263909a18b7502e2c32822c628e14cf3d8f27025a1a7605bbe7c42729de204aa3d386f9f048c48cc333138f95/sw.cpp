...
{
    auto &botan = s.addTarget<LibraryTarget>("randombit.botan", "2.10.0");
    ...
    botan.Public += "org.sw.demo.madler.zlib-1"_dep;
    botan.Public += "org.sw.demo.bearssl-0"_dep;
    botan.Public += "org.sw.demo.xz_utils.lzma"_dep;
    botan.Public += "org.sw.demo.openssl.crypto-*.*.*.*"_dep;
    botan.Public += "org.sw.demo.sqlite3-3"_dep;
    botan.Public += "org.sw.demo.bzip2-1"_dep;
