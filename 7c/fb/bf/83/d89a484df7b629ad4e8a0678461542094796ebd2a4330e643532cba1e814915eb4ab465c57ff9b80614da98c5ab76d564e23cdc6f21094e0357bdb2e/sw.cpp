...
{
    auto &sed = s.addProject("gnu.sed", "4.9.0");
    ...
    auto &gnulib = sed.addTarget<StaticLibraryTarget>("gnulib");
    {
        ...
        gnulib.configureFile("lib/stdckdint.in.h", "stdckdint.h");

        gnulib.Variables["HAVE_SYS_RANDOM_H"] = 0;
        gnulib.Variables["HAVE_GETRANDOM"] = 0;
        gnulib.Variables["GNULIB_GETRANDOM"] = 1;
        gnulib.Variables["REPLACE_GETRANDOM"] = 1;
        gnulib.configureFile("lib/sys_random.in.h", gnulib.BinaryPrivateDir / "sys/random.h");
...
#define _GL_ATTRIBUTE_FORMAT_PRINTF_STANDARD(x,y)
#define _GL_ATTRIBUTE_FORMAT(x)
#define _GL_ATTRIBUTE_SENTINEL(x)
#define _GL_ATTRIBUTE_COLD

#define _GL_FUNCDECL_RPL(f, ret, args) ret f args
#define _GL_CXXALIAS_RPL(f, ret, args)
