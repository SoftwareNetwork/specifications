...
{
    auto &snappy = s.addTarget<LibraryTarget>("google.snappy", "1.1.7");
    ...
    snappy.Public += "org.sw.demo.madler.zlib-1"_dep;
    snappy.Public += "org.sw.demo.oberhumer.lzo.lzo-2"_dep;
}
