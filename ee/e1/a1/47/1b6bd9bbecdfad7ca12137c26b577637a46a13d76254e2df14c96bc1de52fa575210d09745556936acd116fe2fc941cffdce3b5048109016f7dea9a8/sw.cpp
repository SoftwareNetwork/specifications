...
{
    auto &opencv = s.addProject("intel.opencv", "4.1.0");
    ...
    auto add_opencl_kernels = [](auto &t)
    {
        ...
        hpp.addLine("namespace " + t.getPackage().ppath.back() + " {");

        cpp.addLine("// This file is auto-generated. Do not edit!");
        cpp.addLine("#include \"opencv2/core.hpp\"");
        cpp.addLine("#include \"cvconfig.h\"");
        cpp.addLine("#include \"opencl_kernels_" + t.getPackage().ppath.back() + ".hpp\"");
        cpp.addLine("#ifdef HAVE_OPENCL");
        cpp.addLine("namespace cv { namespace ocl {");
        cpp.addLine("namespace " + t.getPackage().ppath.back() + " {");
        cpp.addLine("static const char* const moduleName = \"" + t.getPackage().ppath.back() + "\";");

        // todo
        //auto files = enumerate_files_like(t.SourceDir, "modules/" + t.getPackage().ppath.back() + "/src/opencl/.*\\.cl");
        ...
        t.writeFileOnce("opencl_kernels_" + t.getPackage().ppath.back() + ".hpp", hpp.getText());
        t.writeFileOnce("opencl_kernels_" + t.getPackage().ppath.back() + ".cpp", cpp.getText());
        t += path("opencl_kernels_" + t.getPackage().ppath.back() + ".cpp");
    };
