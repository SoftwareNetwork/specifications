...
{
    auto &s = sln.addDirectory("demo.gnome");
    auto &p = s.addProject("pango", "1.40.14");
    p.Source = RemoteFile("https://ftp.gnome.org/pub/GNOME/sources/pango/{M}.{m}/pango-{v}.tar.xz");
    ...
    pango.Public.Definitions["PANGO_BINARY_AGE"] = "0x" +
    ...
    pango.Public += "pub.cppan2.demo.gnome.glib.gobject-2"_dep;

    pango.writeFileOnce("config.h", "", true);
    ...
    pangoft2.Public += "pub.cppan2.demo.behdad.harfbuzz-1"_dep;
    pangoft2.Public += "pub.cppan2.demo.freedesktop.fontconfig.fontconfig-2"_dep;
    ...
    pangocairo.Public += "pub.cppan2.demo.cairographics.cairo-1"_dep;
