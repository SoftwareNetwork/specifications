...
auto &addBoostTarget(Solution &s, const String &name)
{
    static const std::map<String, String> commits
    {
        ...
        { "algorithm", "ca77e55428152aeb54ecdf65967fc8fa2352482f" },
        { "align", "2dc98d3e164066325cc97cf038155a8707053740" },
        { "any", "1483752ab69e064e4816e7a726fcfaff62712785" },
        { "array", "d026fbcee301275a101c5c67e1f4161766028108" },
        { "asio", "8dee85c35afa493ca35a006bc54442d4661dc064" },
        { "assert", "2cd99e24e834d600d51cf3b8cdc3df6ecfd8e9f1" },
        { "assign", "722683bda9d8bd66231dc2418ba3b9c2879443c2" },
        { "atomic", "ea5911a413a698f5b7a2db24a705bcc358611d0e" },
        { "beast", "393b11be81226af487083fc5b5c4a612d4871c59" },
        { "bimap", "a4317e5c82589d5635a27c2fea02003eeabd072c" },
        { "bind", "f50f42aae9a47299231f42a0c7bbc8d8a958159c" },
        ...
        { "config", "fad75493bd2da03524854976f2d80dd7989c90fb" },
        { "container", "8a2444201ac4856e77b46220cb91beb8e8b3c34d" },
        ...
        { "core", "ca4893063fa244a690b1f799328f16408b794c77" },
        ...
        { "endian", "9420226cbc45aeeda31f3569cdd2f6981cbb4d4d" },
        { "exception", "9bd0584aa9d97adea2d9ed00738c05c8a1b14eba" },
        { "fiber", "f32495bb8969baacbb82a255b9ae250eb6b98ce3" },
        { "filesystem", "9cab675b71e98706886a87afe7c19eb9da568961" },
        { "flyweight", "9b123a8174748073c8f06aece0fe0fe07debf25b" },
        { "foreach", "ba7b0ba950d6dbcfa52645ba41defe8cd6b44ccf" },
        { "format", "5884c3d8140cdcd2d1bef374fcc216244d5faaa5" },
        { "function", "52c8fd15d12a025b7a0e3a215e9b7bbb201bab8a" },
        { "function_types", "95997705ed1a9080601301ee109707cfc8e9a9d8" },
        { "functional", "28b1b25b9464abb3fd5783e10f49df40d6aac2ff" },
        { "fusion", "4a699a39f5e339b8efd6e0ea1a2ea1f747137e54" },
        { "geometry", "4910c25e4c201e90349fd419f18245d4c83da494" },
        ...
        { "histogram", "3ff9fbb97664bcf0b80f684a3391b548e56486c6" },
        ...
        { "interprocess", "2c9e3d731bcdaf487d8e619ba8771145352d213b" },
        { "intrusive", "cb3752dbb1f2e95d28adc541a0e2f4ae72e196a5" },
        { "io", "40b87939b2ce6a0d607e37877f2e36bbaf1f23f7" },
        { "iostreams", "1a260555d51880273d0e3a3ac6782c36f3c131ef" },
        { "iterator", "8e457e716b3b385980921294128b78e6eee23a0f" },
        { "json", "edbf86641b7217676eceb6582ee486e31bb42745" },
        { "lambda", "8824e81d52489be9c8cb21d8f8477b03e675ce66" },
        { "leaf", "21ab0c88ca1f1ef09170bb90e87cdabcd5178ec4" },
        ...
        { "log", "d667377004fef39fe83932c0b15120a7b61a4cbb" },
        { "logic", "1a0a89c5bdd096777c59a7e43dc4cdfb8f6b1cc7" },
        { "math", "a0a97b768afd4188c2985081fab937c0b655df4a" },
        { "metaparse", "e0350c0bfe92a257bf0be2083f2a003f237b5dd8" },
        { "move", "4a60a8eb0660ac83fdb4886c1eb60dc6e6a4b2ca" },
        { "mp11", "21cace4e574180ba64d9307a5e4ea9e5e94d3e8d" },
        { "mpi", "ace80263884ee2af3cef2ab3644ff4b41d154e49" },
        { "mpl", "cc883aa12a61dd0e53b10657eb41a47374726c3c" },
        ...
        { "multiprecision", "b16bcf5f13983656e6bdaddcdf439c366e74691d" },
        { "nowide", "15a2623785be57df8be33c4186a94c64ed827530" },
        ...
        { "optional", "45321f321e9d57236fe4e35a1f4f854e8a69f068" },
        { "outcome", "f247b3e44b292ea6c435abb7d7075dfa7b3d744d" },
        { "parameter", "d59eb4aaddb7297dfc3be048ea5d0493068d81ca" },
        { "parameter_python", "787d8d38d9fd49c34a757b20361f8042dd5ac820" },
        { "pfr", "e15cb59f76df79d808628ffcdbee15779b357a10" },
        { "phoenix", "f9233b64170e9d5ac185e176bf382710d816a3ca" },
        { "poly_collection", "2f0911124076d9f421a090b1c7289a670b6d405e" },
        ...
        { "preprocessor", "5e17804af2496e13ca0cc03d892b5351b637ea43" },
        ...
        { "python", "cc973263c4c8f2476f0ed95ee51562f258ac7da2" },
        { "qvm", "a95d71fa019eebb794e9d6594ab14f420ce1cdd5" },
        { "random", "0251684151cf6017b34cbfa2a0c3c76b60922fe3" },
        ...
        { "regex", "39f28ac456395ec5ded7b40686c9830c87ae63a3" },
        { "safe_numerics", "f311f74cee4b1cf0b96804785f7fefbfae3a6760" },
        { "scope_exit", "3a2c1d7da44af2bb4bf47a4dc051998a80d3194f" },
        { "serialization", "07de314975ce7beb15e618b2021ecbf54ce2c299" },
        { "signals2", "a78b505c7d976407140e877f5250f2a7727a206f" },
        { "smart_ptr", "620620df3d232365bb75216250eafb37421ba7eb" },
        { "sort", "9ff0221684eba9f1a63d2e0c37269c9f4fa5aa70" },
        { "spirit", "e0625d190bef75ce9be96b1963f153c3c9e65ada" },
        ...
        { "static_string", "c59150c0423362360eed6ebc1f9282ca6a8a868e" },
        { "stl_interfaces", "6ab42d5111e6f3e6dc281c0a21d0683184850ccd" },
        { "system", "39bd8ba98fa3b79417c7ef78327198644243f967" },
        ...
        { "timer", "70d1c73a89f9d297d8cf9299035284d143b17341" },
        { "tokenizer", "1c8a8bfd3a8fc2071458884da23ef5ac3a778a0c" },
        { "tti", "8b9f27e5fe05340a0ad411e0f56c91f14f60673a" },
        ...
        { "type_traits", "c6c7ff164789e7ca1d71745714cb27fae956360b" },
        ...
        { "utility", "37168a3f4b455588cc63ead1d861d6129c7f63fa" },
        ...
        { "vmd", "b3981aa6e873b5a819b1c24bd5e33a822dab5dc0" },
        { "wave", "3c48e547743cd07913cf7c4878a5ff7981749578" },
...
void boost_deps(std::unordered_map<String, NativeExecutedTarget*> &boost_targets)
{
...

    {
        ...
        add_public_dependency("any", "winapi", true);
        ...
        add_public_dependency("exception", "detail", true);
        ...
        add_public_dependency("function", "winapi", true);
        ...
        add_public_dependency("functional", "winapi", true);
        ...
        add_public_dependency("interprocess", "align", true);
        ...
        add_public_dependency("iostreams", "align", true);
        ...
        add_public_dependency("lexical_cast", "align", true);
        ...
        add_public_dependency("lexical_cast", "dynamic_bitset", true);
        ...
        add_public_dependency("lexical_cast", "multiprecision", true);
        ...
        add_public_dependency("lexical_cast", "random", true);
        add_public_dependency("lexical_cast", "range", true);
        add_public_dependency("lexical_cast", "rational", true);
        ...
        add_public_dependency("lexical_cast", "system", true);
        ...
        add_public_dependency("local_function", "winapi", true);
        ...
        add_public_dependency("math", "multiprecision", true);
        ...
        add_public_dependency("math", "rational", true);
        ...
        add_public_dependency("move", "detail", true);
        add_public_dependency("move", "predef", true);
        add_public_dependency("move", "preprocessor", true);
        add_public_dependency("move", "static_assert", true);
        add_public_dependency("move", "type_traits", true);
        ...
        add_public_dependency("outcome", "detail", true);
        ...
        add_public_dependency("program_options", "align", true);
        ...
        add_public_dependency("program_options", "dynamic_bitset", true);
        ...
        add_public_dependency("program_options", "multiprecision", true);
        ...
        add_public_dependency("program_options", "random", true);
        add_public_dependency("program_options", "range", true);
        add_public_dependency("program_options", "rational", true);
        ...
        add_public_dependency("program_options", "system", true);
        ...
        add_public_dependency("qvm", "detail", true);
        ...
        add_public_dependency("qvm", "winapi", true);
        add_public_dependency("random", "algorithm", true);
        add_public_dependency("random", "align", true);
        ...
        add_public_dependency("scope_exit", "winapi", true);
        ...
        add_public_dependency("smart_ptr", "detail", true);
        ...
        add_public_dependency("type_index", "winapi", true);
        ...
        add_public_dependency("xpressive", "align", true);
        ...
        add_public_dependency("xpressive", "dynamic_bitset", true);
        ...
        add_public_dependency("xpressive", "multiprecision", true);
        ...
        add_public_dependency("xpressive", "random", true);
        add_public_dependency("xpressive", "range", true);
        add_public_dependency("xpressive", "rational", true);
        ...
        add_public_dependency("xpressive", "system", true);
        ...
        add_public_dependency("yap", "winapi", true);
    }
}
