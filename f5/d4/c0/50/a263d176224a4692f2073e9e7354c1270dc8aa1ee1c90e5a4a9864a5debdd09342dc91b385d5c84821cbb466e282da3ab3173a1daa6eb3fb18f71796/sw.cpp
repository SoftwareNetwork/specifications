...
-we4238 // Promote 'nonstandard extension used : class rvalue used as lvalue' to error.
    ...
    */
    ...
    auto &s = sln.addDirectory("demo.llvm_project");
    ...
    demangle.Variables["LLVM_NATIVE_ASMPARSER"] = "LLVMInitializeX86AsmParser";
    demangle.Variables["LLVM_NATIVE_ASMPRINTER"] = "LLVMInitializeX86AsmPrinter";
    demangle.Variables["LLVM_NATIVE_DISASSEMBLER"] = "LLVMInitializeX86Disassembler";
    demangle.Variables["LLVM_NATIVE_TARGET"] = "LLVMInitializeX86Target";
    demangle.Variables["LLVM_NATIVE_TARGETINFO"] = "LLVMInitializeX86TargetInfo";
    demangle.Variables["LLVM_NATIVE_TARGETMC"] = "LLVMInitializeX86TargetMC";
    ...
    tablegen(Core, "include/llvm/IR/Attributes.td", "llvm/IR/Attributes.inc", { "-gen-attrs" });
    tablegen(Core, "include/llvm/IR/Intrinsics.td", "llvm/IR/Intrinsics.inc", { "-gen-intrinsic" });
        ...
        {"AMDGPU",
         {
             ...
             {"GenSearchableTables.inc", {"-gen-searchable-tables"}},
         }},
        {"ARM",
         {
             {"GenAsmMatcher.inc", {"-gen-asm-matcher"}},
        ...
        {"RISCV",
         {
             ...
             {"GenMCCodeEmitter.inc", {"-gen-emitter"}},
             {"GenMCPseudoLowering.inc", {"-gen-pseudo-lowering"}},
             {"GenCompressInstEmitter.inc", {"-gen-compress-inst-emitter"}},
         }},
    };
