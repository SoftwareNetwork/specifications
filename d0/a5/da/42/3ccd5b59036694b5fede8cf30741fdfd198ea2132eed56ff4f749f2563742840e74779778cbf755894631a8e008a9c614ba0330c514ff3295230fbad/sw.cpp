void build(Solution &s)
{
    ...
    auto &curl = s.addTarget<Executable>("badger.curl", "8.18.0");
    curl += Git("https://github.com/curl/curl", "curl-{M}_{m}_{p}");

    auto &libcurl = curl.addTarget<Library>("libcurl");
    {
        ...
        libcurl.Protected += "lib"_id;
        libcurl.Public += "include"_id;
...

    {
        ...
        curl += "lib/curlx"_idir;
          ...
          ;*/
        curl += libcurl;
        curl.writeFileOnce("tool_hugehelp.c", R"(
