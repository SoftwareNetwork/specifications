...
{
    auto &pixman = s.addTarget<StaticLibraryTarget>("freedesktop.pixman", "0.43.4");
    pixman += Git("https://gitlab.freedesktop.org/pixman/pixman", "pixman-{v}");
    ...
    pixman.Variables["PIXMAN_VERSION_MAJOR"] = pixman.Variables["PACKAGE_VERSION_MAJOR"];
    pixman.Variables["PIXMAN_VERSION_MINOR"] = pixman.Variables["PACKAGE_VERSION_MINOR"];
    pixman.Variables["PIXMAN_VERSION_MICRO"] = pixman.Variables["PACKAGE_VERSION_PATCH"];
    pixman.configureFile("pixman/pixman-version.h.in", "pixman-version.h");
}
