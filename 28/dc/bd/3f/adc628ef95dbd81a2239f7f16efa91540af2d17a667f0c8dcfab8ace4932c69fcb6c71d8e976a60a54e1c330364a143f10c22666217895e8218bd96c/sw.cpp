...
void boost_deps(std::unordered_map<String, NativeExecutedTarget*> &boost_targets)
{
    ...
    auto add_public_dependency2 = [](auto &&t1, auto &&t2, bool idir_only = false)
    {
        if (!t2) return;
        auto dt = t1.Public + t2;
        dt->IncludeDirectoriesOnly = idir_only;
...

    {
        ...
        add_public_dependency("accumulators", "compat", true);
        ...
        add_public_dependency("algorithm", "compat", true);
        ...
        add_public_dependency("asio", "compat", true);
        ...
        add_public_dependency("assign", "compat", true);
        ...
        add_public_dependency("beast", "compat", true);
        ...
        add_public_dependency("chrono", "compat", true);
        ...
        add_public_dependency("cobalt", "compat", true);
        ...
        add_public_dependency("compute", "compat", true);
        ...
        add_public_dependency("contract", "compat", true);
        ...
        add_public_dependency("convert", "compat", true);
        ...
        add_public_dependency("coroutine", "compat", true);
        ...
        add_public_dependency("date_time", "compat", true);
        ...
        add_public_dependency("dll", "compat", true);
        ...
        add_public_dependency("fiber", "compat", true);
        ...
        add_public_dependency("filesystem", "compat", true);
        ...
        add_public_dependency("flyweight", "compat", true);
        ...
        add_public_dependency("geometry", "compat", true);
        ...
        add_public_dependency("gil", "compat", true);
        ...
        add_public_dependency("graph", "compat", true);
        ...
        add_public_dependency("graph_parallel", "compat", true);
        ...
        add_public_dependency("histogram", "compat", true);
        ...
        add_public_dependency("icl", "compat", true);
        ...
        add_public_dependency("iostreams", "compat", true);
        ...
        add_public_dependency("json", "compat", true);
        ...
        add_public_dependency("locale", "compat", true);
        ...
        add_public_dependency("log", "compat", true);
        ...
        add_public_dependency("math", "compat", true);
        ...
        add_public_dependency("mpi", "compat", true);
        ...
        add_public_dependency("mqtt5", "compat", true);
        ...
        add_public_dependency("msm", "compat", true);
        ...
        add_public_dependency("msm", "json", true);
        ...
        add_public_dependency("multiprecision", "compat", true);
        ...
        add_public_dependency("nowide", "compat", true);
        ...
        add_public_dependency("odeint", "compat", true);
        ...
        add_public_dependency("ublas", "compat", true);
        ...
        add_public_dependency("openmethod", "assert", true);
        add_public_dependency("openmethod", "config", true);
        add_public_dependency("openmethod", "container_hash", true);
        add_public_dependency("openmethod", "core", true);
        add_public_dependency("openmethod", "describe", true);
        add_public_dependency("openmethod", "dynamic_bitset", true);
        add_public_dependency("openmethod", "mp11", true);
        add_public_dependency("openmethod", "preprocessor", true);
        add_public_dependency("openmethod", "smart_ptr", true);
        add_public_dependency("openmethod", "throw_exception", true);
        ...
        add_public_dependency("outcome", "compat", true);
        ...
        add_public_dependency("parameter_python", "compat", true);
        ...
        add_public_dependency("poly_collection", "compat", true);
        ...
        add_public_dependency("process", "compat", true);
        ...
        add_public_dependency("property_map_parallel", "compat", true);
        ...
        add_public_dependency("property_tree", "compat", true);
        ...
        add_public_dependency("ptr_container", "compat", true);
        ...
        add_public_dependency("python", "compat", true);
        ...
        add_public_dependency("random", "compat", true);
        ...
        add_public_dependency("redis", "compat", true);
        ...
        add_public_dependency("serialization", "compat", true);
        ...
        add_public_dependency("spirit", "compat", true);
        ...
        add_public_dependency("statechart", "compat", true);
        ...
        add_public_dependency("system", "compat", true);
        ...
        add_public_dependency("test", "compat", true);
        ...
        add_public_dependency("thread", "compat", true);
        ...
        add_public_dependency("type_erasure", "compat", true);
        ...
        add_public_dependency("units", "compat", true);
        ...
        add_public_dependency("unordered", "compat", true);
        ...
        add_public_dependency("url", "compat", true);
        ...
        add_public_dependency("wave", "compat", true);
