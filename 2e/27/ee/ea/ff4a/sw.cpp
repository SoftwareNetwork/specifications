void build(Solution &sln)
{
    ...
    json_c.Source = Git("https://github.com/json-c/json-c", "", "{v}");
...
void check(Checker &c)
{
    ...
    /*s.checkDeclarationExists("INFINITY");
    s.checkDeclarationExists("_finite");
    s.checkDeclarationExists("_isnan");
    s.checkDeclarationExists("isinf");
    s.checkDeclarationExists("isnan");
    s.checkDeclarationExists("nan");*/
}
