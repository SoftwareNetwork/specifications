...
{
    auto &hdf = s.addProject("hdfgroup.hdf5", "1.12.0");
    ...
    auto &hdf5 = hdf.addTarget<LibraryTarget>("hdf5");
    {
        ...
        hdf5 += "H5_HAVE_ZLIB_H=1"_v;
        hdf5 += "H5_HAVE_CURL_H=1"_v;
...
void check(Checker &c)
{
    ...
    s.checkIncludeExists("sys/proc.h");
    ...
    #include <sys/time.h>
    int main() {return 0;}
    )sw_xxx").Definitions.insert("TIME_WITH_SYS_TIME");
