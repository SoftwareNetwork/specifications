...
auto &addBoostTarget(Solution &s, const String &name)
{
    static std::map<String, String> commits{
        ...
        {"algorithm", "badf1b3f0c7d75ad1f688ed373459e386832cac9"},
        {"align", "596f6ee1aa890bd803c1e9f60ae243425568ee01"},
        {"any", "d962e210f8fc0cfb99f475627563193ba09cbf16"},
        {"array", "8f3aea2200fa45ed4c1829b3d3148432867dda87"},
        {"asio", "25dc6780c2c73dd6a4d74e65e854fc0f705cbb60"},
        {"assert", "4bd93cd4141b5d48e090495551e3bce931321f62"},
        {"assign", "743c3f3c57254a93982cc1ecdae8e518f24c651a"},
        {"atomic", "19eecf893c665410de63ab6ebb8549f405703e80"},
        {"beast", "1da229a27c6f0539d422bcedbcf47cfe2517164a"},
        ...
        {"chrono", "15d3e2af0e06ae4ae40bd003007040896fc72e97"},
        {"circular_buffer", "4ef6e8d1f6e709ddc8fb07af082f04aac920ab0c"},
        {"compatibility", "445fbc1633cbaf49b0c3310db95a642e9c3fe89b"},
        {"compute", "9189a761b79fcd4be2f38158b9cad164bac22fa2"},
        {"concept_check", "ed0a0ebd72f778cfa4931e0538ea34c28db3a42b"},
        {"config", "bb3c8a20dcb3a97e0c999a5869305398fa6d8a11"},
        {"container", "1ad64316a432a7f021b4956acf88abc6aaa8a77e"},
        {"container_hash", "9fbda1a98a32498c52a1c8ebf62311bb36a44ad4"},
        {"context", "e7d92e75d1573a545eaf70e6ba3090e006db6e83"},
        {"contract", "27dba1d8e9b9d7521ef3802ae73a07d5357f1773"},
        {"conversion", "2a0a2a59f593fb1545468b43b022e921ab20c8e3"},
        {"convert", "0d7f18d689e9661865c4db2d166eac329d4ad9e0"},
        {"core", "e128f4e1b8904d47561700892843f07d5d1160db"},
        {"coroutine", "8df277dc820701e6a62f5ae4018e7b7190490eb8"},
        {"coroutine2", "e1b3ca3179f3daecc5fab6ffeb35ae321e6b138f"},
        {"crc", "e77694d0acb1ce9c1fa38d0965f13b53a9949ca3"},
        {"date_time", "66ee8bf48fbec95ae4dfa59a128b3b3305261455"},
        {"detail", "824721a7533de893338ed5bbc8e8d9f4fb1ad716"},
        {"disjoint_sets", "4980fe2a87ead3b2e8260aed6e9c8835266cd5d7"},
        {"dll", "89f887e8a3a4ce8dd5618b7c2d22ad1d737291fa"},
        {"dynamic_bitset", "4f54d83981e0661071cb54a3bfde16fde3c350e6"},
        {"endian", "f6998d2406be7b5d7a03cae93c72bb097bfbc87a"},
        {"exception", "dcd2d83b34458fef1b3b836d13fa4ee9429a8bec"},
        {"fiber", "2112ee33c8f8cfbea492d9c6286f48a48eb5247c"},
        {"filesystem", "5a93351bfdf859ee47245e0429739226767ef0d7"},
        {"flyweight", "0c41920a354cee27cf86a7f75569c70fb8900c78"},
        {"foreach", "4240a1d095cf4a5e04093a1b91b1f0c791a58da9"},
        {"format", "a1c613764dd96f97749e1e059c80f0f3515fcf0b"},
        {"function", "feea19660bcac246fc054f0a890415d01e884c4b"},
        {"function_types", "ae4fde2e2ae88291d6d656137169ff4003d184a1"},
        {"functional", "7516442815900430cc9c4a6190354e11bcbe72dd"},
        {"fusion", "c740a4dbadb5daf836f2f8ab024e6ae5fa331dde"},
        {"geometry", "21362e7cb27e6d535d591e7e8447af3dd66cd82d"},
        {"gil", "56c23895002bef72a7a74324d81c584a2fae667a"},
        {"graph", "815268534fc04adf00c9f5bd6803328e20fe14c1"},
        {"graph_parallel", "6d4757c56f8d3d5bb2efa4c5d46119af305ef441"},
        {"hana", "6187d448df49db085d4d7ad63d3a5f479594c5cf"},
        {"heap", "173349cee1942992f322f26fff2b6243319e7d65"},
        {"hof", "7e7610854ecec699af8503e44c48383828c44734"},
        {"icl", "adaf950fadf370ed4b8a33153d6510bff242ff06"},
        {"integer", "66dbc2c70aecc47d5a711b5dac6da6237721a644"},
        {"interprocess", "6fbaf9bc6a2469dabd4ca9c2faa94272bbbb79ed"},
        {"intrusive", "785797ffab4f1d4ab3e01f53b0381e49629ea8fd"},
        {"io", "5fa66f1f76fb9142765692cc0cf6e40af8d08c45"},
        {"iostreams", "1680ef8b7692a77ee2abf385d87f64076332a595"},
        {"iterator", "b2adecb951af025698618f19a3c838bd314966dc"},
        {"lambda", "b8a2f400acceb3f1bc399287837499bfecd57cf5"},
        {"lexical_cast", "5bfe6672d467ebd8de5d911c07b2a931b43156de"},
        {"local_function", "9ea3674299e3185ccdacf9dad5060d070ae9d77e"},
        {"locale", "07eb6bcbee80c8acaa202dbd433c674a7591ade9"},
        {"lockfree", "38f0cfc28d984cba8b368695491f9cc45bca2363"},
        {"log", "cf8b4a3238ce27e3abd2fba662c5118de4c6493c"},
        {"logic", "e824ad54e0443e9531d9b8111a0e361aca0a2aed"},
        {"math", "0e9549ff2f854e6edafaf4627d65026f2f533a18"},
        {"metaparse", "1cb74cdbe1b989a576b0b8f7fe34151562840797"},
        {"move", "d503fbe1c8334fa8885e67cb83c96aeaf3938555"},
        {"mp11", "05a366e8ba929ad60dd51e02e5165665a98a2531"},
        {"mpi", "30f32d531932809e3122fdeebbea629023854eeb"},
        {"mpl", "270f33f67998ffaac6afdae25fe06be2ee744d6e"},
        {"msm", "fc3671a41c583aefd6b40c15673b83589e4f4220"},
        {"multi_array", "abcb2839d56669d1b5bb8a240ec644f47c66beb2"},
        {"multi_index", "d95a94942b918140e565feb99ed36ea97c30084e"},
        {"multiprecision", "beb1f790c3c652cae8e31b11ae8d1e5f251c6b2e"},
        {"numeric", "36f969a4c5129d11a8913fcbd8d2732ba957315b"},
        {"interval", "268c316586d970bad146340d21d747adfc370712"},
        {"odeint", "6ff2719b6907b86596c3d43e88c1bcfdf29df560"},
        {"ublas", "e8607b3eea238e590eca93bfe498c21f470155c1"},
        {"optional", "155ad5911e5683cc87d34363f8304b60a30a8345"},
        {"parameter", "672ae1c0cec1eb16cf2613d53c483554244a251b"},
        {"phoenix", "faffaf8e59a7e6c9aaeeb9d033e2bd5f06775c9f"},
        {"poly_collection", "0d7b1374f1450932933b3475d00bbb593b7b3c7f"},
        {"polygon", "8ffe9e08615dc9f56e4058fb51fe3254cb7443e0"},
        {"pool", "9daab9f821d4d047f50fea75a62b4f3130ad6a03"},
        {"predef", "560ff5298ead78276872604f1ee6523e63a4fa90"},
        {"preprocessor", "56090c56b5c78418b6dbe8c3c2ba576395152f83"},
        {"process", "44162ecf2243c7cbea412830eddb43d041469eae"},
        {"program_options", "bc0c90a70f0435ee4ce65b97a68d864a7d627e35"},
        {"property_map", "2f56dce3ffab40bd67b8807ecc6916a84c6d09ef"},
        {"property_tree", "bdfe275d172ac30bc5e89a6375a5a64dea20b3c0"},
        {"proto", "d70c74c3a8d2abe746fe017edee564e6e8ae0efc"},
        {"ptr_container", "67915a7f8610247b7bac4ca41b03702b54f4933a"},
        {"python", "6f72675bff276599ffdccb9681018d8b2e367bc2"},
        {"qvm", "364708ff20900d5d6d1aa249d142a481e68e9c26"},
        {"random", "1559df6b194cbba86653a2e2fefc2ea15e2cecd2"},
        {"range", "4cfd4d8287ca949d7f29256adf3e796a0d1775ec"},
        {"ratio", "ee45b0666f89e2703d8496d243c297082bfc668c"},
        {"rational", "2c7fe1aae7fdb72458754d76aa2d0d57542264b7"},
        {"regex", "a9fc8fb5de8262cdf100ff2af06d2c819f251b4e"},
        {"scope_exit", "3c093a0b862a7246c47b0f3894d91d710e25c747"},
        {"serialization", "738695b70733f9d592a570fb17a505d6a029b48a"},
        {"signals", "613b2a55b602501bf6dfe3da8fb2218e1ffc2862"},
        {"signals2", "0c51b5dcbf5961054447ce83f467e6e99db16c54"},
        {"smart_ptr", "e37cd4154f492b3cd2ea8e87806614ffddf1163a"},
        {"sort", "524289041099f521a6d69f8858d384d537ffa6af"},
        {"spirit", "80ac3212a33c2921cef2212138da751da64852b9"},
        {"stacktrace", "7fedfa12654d18a9fa695de258763e93699c4636"},
        {"statechart", "066189ef5560ec847eb74ec2df6ec5f18b92373f"},
        {"static_assert", "afe9e9d7864e23d50077115d51fa8ce17fc2e8be"},
        {"system", "13199e504c0cacb428b58819f5a3d7ccf8911a8b"},
        {"test", "cd93cf5a692e51a060c283fd7bd178c7f0cd5d28"},
        {"thread", "377bb87ad5875ddf357cbcf8aee51659d979f916"},
        {"throw_exception", "c548923b32735fcbc6cdf34c8e9b382d58b4b407"},
        {"timer", "cb59c5cff1d044d875b4c5984a46efcffa6c9df5"},
        {"tokenizer", "fbb3cd559a81d0b3ce9203dce4d80083b3422853"},
        ...
        {"type_index", "c2caa340ab9d9d834c5ffafb3f267b3c46c8c821"},
        {"type_traits", "059ed8839da3fecd1e8b62cdc11be006f6346b5e"},
        {"typeof", "080f05ea46271c745f7a748815a64210deb0a880"},
        {"units", "57389b7374a6f7a4caf87cc44092bb8d0db65ec6"},
        {"unordered", "9abce00f240f4d7b38c335c1f86262e7ea16018d"},
        {"utility", "ebe44296ca698e333a09e8268ea8ccedb3886c4d"},
        {"uuid", "9522a13919c75ceade063c7e8d6bc785f2814416"},
        {"variant", "98b5d42e6d8fc188c40a56aa3a558bed595ee643"},
        {"vmd", "9a31758d1b46995c72058d082302092b0adaaabb"},
        {"wave", "5699f9a4edd86e84c237cd968e8fb6e29db8fc21"},
        {"winapi", "3f56c2348fe1eee510da9ed1fb7763d74ea304d3"},
        {"xpressive", "4d4bc69f8b05e63c744e6f477df6a364affbc603"},
        {"yap", "2e8e2020ec242b1c6e7649f4828811f3df6ae14c"},
    };

    PackagePath p = "boost";
    p /= name;

    auto &t = s.addTarget<T>(p, "1.68.0");
...
void boost_deps(std::unordered_map<String, NativeExecutedTarget*> &boost_targets)
{
...

    {
        ...
        add_public_dependency("filesystem", "algorithm", true);
        ...
        add_public_dependency("filesystem", "container", true);
        ...
        add_public_dependency("filesystem", "exception", true);
        ...
        add_public_dependency("filesystem", "intrusive", true);
        ...
        add_public_dependency("filesystem", "unordered", true);
        ...
        add_public_dependency("gil", "algorithm", true);
        add_public_dependency("gil", "array", true);
        ...
        add_public_dependency("gil", "container", true);
        ...
        add_public_dependency("gil", "exception", true);
        ...
        add_public_dependency("gil", "intrusive", true);
        ...
        add_public_dependency("gil", "range", true);
        add_public_dependency("gil", "regex", true);
        ...
        add_public_dependency("gil", "unordered", true);
        ...
        add_public_dependency("heap", "multiprecision", true);
        ...
        add_public_dependency("lockfree", "multiprecision", true);
        ...
        add_public_dependency("parameter", "multiprecision", true);
        ...
        add_public_dependency("pool", "dynamic_bitset", true);
        ...
        add_public_dependency("pool", "multiprecision", true);
