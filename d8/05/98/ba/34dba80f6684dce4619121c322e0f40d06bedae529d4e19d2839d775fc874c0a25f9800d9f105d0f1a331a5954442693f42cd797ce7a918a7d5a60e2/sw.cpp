...
void build(Solution &s) {
    auto &python = s.addProject("python", "3.13.5");
    ...
    auto python_lib = [](auto &&lib) -> decltype(auto) {
    {
        ...
        lib += "pyconfig.h.in", "Include/.*"_rr, "Modules/.*\\.h"_rr, "Modules/_abc.c", "Modules/_bisectmodule.c",
            ...
            //"Modules/audioop.c",
            "Modules/binascii.c", "Modules/cjkcodecs/_codecs_cn.c",
            ...
            "Objects/listobject.c", "Objects/longobject.c", "Objects/memoryobject.c",
        ...
        lib += "Include/internal/mimalloc"_idir
            , "Objects/mimalloc"_idir
            ;
        ...
        if (lib.getBuildSettings().TargetOS.Type == OSType::Windows || lib.getBuildSettings().TargetOS.Type == OSType::Mingw) {
            ...
            lib.replaceInFileOnce("PC/pyconfig.h.in", "#ifdef MS_COREDLL", "#if 0");
            lib.configureFile("PC/pyconfig.h.in", "pyconfig.h", ConfigureFlags::EnableUndefReplacements);
        } else {
...
#  include "osdefs.h"
    ...
    auto &exe = python.addTarget<PythonExecutable>("exe");
    {
        ...
        // https://github.com/python/cpython/issues/89786
        // fixed already?
        ...
        exe.patch("Lib/site.py",
            R"return f'{userbase}\\{implementation}{ver_nodot}\\site-packages'",
