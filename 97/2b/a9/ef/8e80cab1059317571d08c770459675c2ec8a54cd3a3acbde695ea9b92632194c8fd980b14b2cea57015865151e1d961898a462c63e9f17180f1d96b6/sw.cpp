...
{
    auto &ffmpeg = s.addProject("ffmpeg", "4.0.2");
    ffmpeg += Git("https://github.com/FFmpeg/FFmpeg", "n{v}");
...
R"(
    ...
    auto &avresample = ffmpeg.addTarget<LibraryTarget>("avresample");
    {
        avresample +=
            "libavresample/.*\\.c"_rr,
            "libavresample/.*\\.h"_rr;
        setup(avresample, "libavresample");
    ...
    auto &avcodec = ffmpeg.addTarget<LibraryTarget>("avcodec");
    {
        ...
        avcodec.Public += "org.sw.demo.gnu.iconv.libiconv-1"_dep;
        avcodec.Public += "org.sw.demo.bzip2-1"_dep;
        avcodec.Public += "org.sw.demo.webmproject.webp-1"_dep;
        avcodec.Public += "org.sw.demo.xz_utils.lzma-5"_dep;
        avcodec.Public += "org.sw.demo.xiph.vorbis.libvorbis-1"_dep;
    ...
    auto &avdevice = ffmpeg.addTarget<LibraryTarget>("avdevice");
    {
        ...
        if (s.Settings.TargetOS.Type == OSType::Windows)
        {
            ...
            avdevice.Public += "Vfw32.lib"_lib;
        }
