...
{
    //auto &p = s.addProject("CGAL.cgal", "5.0.2");
    auto &p = s.addStaticLibrary("CGAL.cgal", "5.0.2");
    p += Git("https://github.com/CGAL/cgal", "releases/CGAL-{v}");
    ...
    auto &i = add_dir("Installation");
    {
        ...
        i.patch("Installation/include/CGAL/internal/enable_third_party_libraries.h",
            "! __has_include(<gmp.h>)",
