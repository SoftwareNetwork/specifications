struct PerlExecutable : ExecutableTarget
{
    ...
    {
        c.environment["PERL5LIB"] = (SourceDir / "lib").u8string();
    }
...
{
    auto &p = s.addProject("perl", "5.29.7");
...
#undef USE_CPLUSPLUS
    ...
    auto &lib = p.addTarget<Library>("lib");
    {
