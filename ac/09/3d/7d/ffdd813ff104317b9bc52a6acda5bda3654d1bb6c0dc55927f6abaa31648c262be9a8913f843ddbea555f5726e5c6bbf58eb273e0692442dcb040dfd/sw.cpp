...
{
    auto &icu = s.addProject("unicode.icu", "78.1.0");
    auto url = "https://github.com/unicode-org/icu/releases/download/release-{M}.{m}/icu4c-{M}.{m}-sources"s;
    icu += RemoteFile(url + ".tgz");
