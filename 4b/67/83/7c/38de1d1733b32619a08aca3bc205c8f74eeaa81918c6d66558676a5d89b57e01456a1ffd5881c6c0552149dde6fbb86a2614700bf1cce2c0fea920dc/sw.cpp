...
void build(Solution &s)
{
    ...
    // base
    {
        ...
        auto &platformsupport = base.addDirectory("platformsupport");
        {
            ...
            auto &fontdatabases = platformsupport.addDirectory("fontdatabases");
            {
                ...
                auto &windows = fontdatabases.addTarget<StaticLibraryTarget>("windows");
                {
                    String module = "QtFontDatabaseSupport";
        ...
        auto &windows = platforms.addTarget<LibraryTarget>("windows");
        {
            ...
            windows.Public += platformsupport.getTarget<NativeTarget>("accessibility");
            windows.Public += platformsupport.getTarget<NativeTarget>("eventdispatchers");
            windows.Public += platformsupport.getTarget<NativeTarget>("themes");
            windows.Public += platformsupport.getTarget<NativeTarget>("windowsuiautomation");
            windows.Public += platformsupport.getTarget<NativeTarget>("fontdatabases.windows");
...

    {
        ...
        svg.SourceDir /= "src/svg";
        svg += "[^/]*"_rr;
        svg.Private += "QT_BUILD_SVG_LIB"_d;
        svg.Public += base.getTarget<NativeTarget>("widgets");
        if (s.Settings.TargetOS.Type == OSType::Windows)
        {
    ...
    change_local_dir(winextras, "qtwinextras");

    {
        ...
        winextras.Public += base.getTarget<NativeTarget>("gui");
        if (s.Settings.TargetOS.Type == OSType::Windows)
        {
    ...
    change_local_dir(tools, "qttools");

    {
        ...
        auto &formats = linguist.addTarget<StaticLibraryTarget>("formats");
        {
            ...
            formats.Public += base.getTarget<NativeTarget>("xml");
        ...
        auto &proparser = linguist.addTarget<StaticLibraryTarget>("proparser");
        {
            ...
            proparser.Public += base.getTarget<NativeTarget>("core");
        }
    ...
    change_local_dir(imageformats, "qtimageformats");

    {
        auto add_imageformat = [&s, &base, &moc](auto &parent, const String &name) -> decltype(auto)
        {
            ...
            t.Public += base.getTarget<NativeTarget>("gui");
            return t;
        };
    ...
    change_local_dir(declarative, "qtdeclarative");

    {
        ...
        auto &masm = third_party.addStaticLibrary("masm");
        {
            ...
            masm.Public += base.getTarget<NativeTarget>("core");
        ...
        // qml
        {
            ...
            qml += masm;
            qml.Public += base.getTarget<NativeTarget>("network");
        ...
        auto &quick = declarative.addLibrary("quick");
        {
            ...
            quick.Public += qml, base.getTarget<NativeTarget>("gui");
