void build(Solution &sln)
{
    ...
    auto &nghttp2 = s.addTarget<LibraryTarget>("nghttp2", "1.27.0");
    nghttp2.Source = Git("https://github.com/nghttp2/nghttp2", "v{M}.{m}.{p}");
    ...
    nghttp2.configureFile("cmakeconfig.h.in", "config.h");
}
