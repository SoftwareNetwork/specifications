...
{
    auto &p = s.addProject("google.protobuf", "22.0.0");
    //p += Git("https://github.com/protocolbuffers/protobuf", "v{M}.{m}");
    p += RemoteFile("https://github.com/protocolbuffers/protobuf/releases/download/v{M}.{m}/protobuf-{M}.{m}.tar.gz");
    ...
    auto lite_sources = [&](auto &&t, auto &&f) {
        for (auto &&fn : {
        ...
        if (win_or_mingw(t)) {
            f("src/google/protobuf/io/io_win32.cc");
        }
    };
    ...
    auto &protobuf_lite = p.addTarget<LibraryTarget>("protobuf_lite");
    {
        ...
        lite_sources(protobuf_lite, [&](auto &&fn) { protobuf_lite += fn; });
        ...
        protobuf_lite.Public += "org.sw.demo.google.protocolbuffers.utf8_range-main"_dep;
    ...
    auto &protobuf = p.addTarget<LibraryTarget>("protobuf");
    {
        ...
        protobuf +=
            ...
            "src/google/protobuf/io/zero_copy.*"_rr,
            ...
            ;
        protobuf -= ".*_plugin.*"_rr;
        protobuf -= ".*_test.*"_rr;
        protobuf -= ".*mock.*"_rr;
        protobuf -= ".*unittest.*"_rr;
        lite_sources(protobuf, [&](auto &&fn) { protobuf -= fn; });
    ...
    auto &protoc_lib = p.addTarget<LibraryTarget>("protoc_lib");
    {
        ...
        protoc_lib +=
            "src/google/protobuf/compiler/.*"_rr
            ;
        protoc_lib -=
            "src/google/protobuf/compiler/importer.cc",
            "src/google/protobuf/compiler/parser.cc"
            ;
        protoc_lib -= ".*_plugin.*"_rr;
        protoc_lib -= ".*_test.*"_rr;
        protoc_lib -= ".*mock.*"_rr;
        protoc_lib -= ".*unittest.*"_rr;
