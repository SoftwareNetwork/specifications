...
{
    auto &pqxx = s.addTarget<LibraryTarget>("jtv.pqxx", "8.0.2");
    ...
    pqxx.configureFile("include/pqxx/internal/config.h.in", "pqxx/internal/config.h", ConfigureFlags::EnableUndefReplacements);
}
