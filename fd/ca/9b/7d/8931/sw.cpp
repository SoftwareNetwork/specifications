void build(Solution &sln)
{
    ...
    auto &libarchive = s.addTarget<LibraryTarget>("libarchive.libarchive", "3.3.1");
    libarchive.Source = Git("https://github.com/libarchive/libarchive", "v{M}.{m}.{p}");
    ...
    libarchive.Public += "pub.cppan2.demo.bzip2-1"_dep;
    libarchive.Public += "pub.cppan2.demo.gnu.nettle.nettle-3"_dep;
    libarchive.Public += "pub.cppan2.demo.lz4-1"_dep;
    libarchive.Public += "pub.cppan2.demo.libxml2-2"_dep;
    libarchive.Public += "pub.cppan2.demo.madler.zlib-1"_dep;
    libarchive.Public += "pub.cppan2.demo.oberhumer.lzo.lzo-2"_dep;
    libarchive.Public += "pub.cppan2.demo.xz_utils.lzma-5"_dep;
    ...
    libarchive.configureFile("build/cmake/config.h.in", "config.h");
}
