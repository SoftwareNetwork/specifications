void build(Solution &sln)
{
    ...
    auto &libxml2 = s.addTarget<LibraryTarget>("libxml2", "2.9.6");
    libxml2.Source = RemoteFile("ftp://xmlsoft.org/libxml2/libxml2-{M}.{m}.{p}.tar.gz");
    ...
    libxml2.Public += "pub.cppan2.demo.gnu.iconv.libiconv-1"_dep;
    libxml2.Public += "pub.cppan2.demo.madler.zlib-1"_dep;

    libxml2.Variables["VERSION"] = libxml2.pkg.version.toString();
    libxml2.Variables["LIBXML_VERSION_NUMBER"] = std::to_string(libxml2.pkg.version.toNumber());
    libxml2 +=
        "WITH_ZLIB=1"_v,
        "WITH_LZMA=0"_v,
        "WITH_ICU=0"_v,
    ...
    libxml2.fileWriteOnce("config.h",
        R"(
#ifdef _WIN32
