...
void boost_deps(std::unordered_map<String, NativeExecutedTarget*> &boost_targets)
{
...

    {
        ...
        add_public_dependency("cobalt", "coroutine", true);
        ...
        add_public_dependency("cobalt", "leaf", true);
        ...
        add_public_dependency("interprocess", "variant2", true);
        ...
        add_public_dependency("redis", "coroutine", true);
