...
{
    auto &p = s.addProject("gnome.pango", "1.58.0");
    p += Git("https://gitlab.gnome.org/GNOME/pango");
    ...
    auto &pangocairo = p.addTarget<LibraryTarget>("pangocairo");
    {
        ...
        // bug
        pangocairo.replaceInFileOnce("pango/pangocoretext.c",
            "priv->fontmap = fontmap;", "priv->fontmap = (PangoFontMap*)fontmap;");
    }
}
