...
{
    auto &AcademySoftwareFoundation = s.addDirectory("AcademySoftwareFoundation");

    auto &Imath = AcademySoftwareFoundation.addLibrary("Imath", "3.0.5");
    Imath += Git("https://github.com/AcademySoftwareFoundation/Imath", "v{v}");
    {
        ...
        Imath -= "eLut.cpp", "toFloat.cpp";
        Imath.Public += sw::Shared, "IMATH_DLL"_def;
        Imath += sw::Shared, "IMATH_EXPORTS"_def;
    }

    auto &openexr = AcademySoftwareFoundation.addProject("openexr", "3.0.5");
