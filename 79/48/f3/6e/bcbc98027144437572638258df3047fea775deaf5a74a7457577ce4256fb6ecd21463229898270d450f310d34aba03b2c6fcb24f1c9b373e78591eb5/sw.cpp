...
{
    auto &sdk = s.addProject("amazon.aws.sdk", "1.7.162");
    ...
    auto &core = add_target("core");
    {
        ...
        if (core.getBuildSettings().TargetOS.Type == OSType::Windows)
        {
            ...
            core.Public += "bcrypt.lib"_slib;
            core.Public += "rpcrt4.lib"_slib;
            core.Public += "userenv.lib"_slib;
            core.Public += "winhttp.lib"_slib;
            core.Public += "wininet.lib"_slib;
        }
