...
{
    auto &libtorrent = s.addTarget<LibraryTarget>("arvidn.libtorrent", "1.1.11");
    libtorrent += RemoteFile("https://github.com/arvidn/libtorrent/releases/download/libtorrent_{M}_{m}_{p}/libtorrent-rasterbar-{v}.tar.gz");
