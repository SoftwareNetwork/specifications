...
{
    auto &nghttp2 = s.addTarget<LibraryTarget>("ngtcp2", "0.1.0");
    nghttp2 += Git("https://github.com/ngtcp2/ngtcp2", "v{v}");
    ...
    nghttp2.Private += "BUILDING_NGTCP2"_d;
    nghttp2.Public += sw::Static, "NGTCP2_STATICLIB"_d;
    ...
    nghttp2.configureFile("lib/includes/ngtcp2/version.h.in", "ngtcp2/version.h");
