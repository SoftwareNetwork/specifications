...
{
    auto &poco = s.addProject("poco", "1.15.1");
    ...
    auto &foundation = add_library("Foundation");
    {
        ...
        foundation.Public += "POCO_SILENCE_DEPRECATED"_def;
        ...
        if (foundation.getCompilerType() == CompilerType::MSVC) {
            foundation.Protected.CompileOptions.push_back("/Zc:preprocessor");
            foundation.Protected.CompileOptions.push_back("/Zc:__cplusplus");
        }

        foundation.Public += "org.sw.demo.madler.zlib"_dep;
        foundation.Public += "org.sw.demo.odygrd.quill"_dep;
        foundation.Public += "org.sw.demo.pcre.pcre8-10"_dep;
        foundation.Public += "org.sw.demo.google.double_conversion"_dep;
        foundation.Public += "org.sw.demo.JuliaStrings.utf8proc"_dep;
        foundation.patch("src/Unicode.cpp", "_pcre2_ucp", "pcre2_ucp");
        foundation.patch("src/Unicode.cpp", "_pcre2_ucd", "pcre2_ucd");
    }

    auto &data_sqlparser = add_library("SQLParser", "Data/SQLParser");
    data_sqlparser.Public += foundation;
    data_sqlparser.patch("src/sqlparser_win.h", "#ifdef Data_API", "#if 0");

    auto &data = add_library("Data");
    data.Public += data_sqlparser;
    ...
    json.Public += "org.sw.demo.skeeto.pdjson-master"_dep;
    ...
    net.Public += util;
    net.Public += "org.sw.demo.piscisaureus.wepoll"_dep;
    ...
    _7zip.Public += util;
    _7zip.Public += "org.sw.demo._7zip._7z"_dep;
    ...
    doc.Public += util, cppparser, sqlite;
}
