void build(Solution &sln)
{
    ...
    intl.Source = RemoteFile("http://ftp.gnu.org/pub/gnu/gettext/gettext-0.19.8.1.tar.gz");
    ...
    intl.Public += "pub.cppan2.demo.gnu.iconv.libiconv-1"_dep;
    ...
    intl.fileWriteOnce("config.h", R"xxx(
#pragma once
