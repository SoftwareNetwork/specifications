void build(Solution &sln)
{
    ...
    auto &cairo = s.addTarget<LibraryTarget>("cairographics.cairo", "1.15.8");
    cairo.Source = Git("git://git.cairographics.org/git/cairo", "{v}");
    ...
    if (s.Settings.TargetOS.Type == OSType::Windows)
    {
        ...
        cairo.Public += "CAIRO_HAS_PTHREAD=0"_d;
    ...
    cairo.Public += "pub.cppan2.demo.freedesktop.fontconfig.fontconfig-2"_dep;
    cairo.Public += "pub.cppan2.demo.freedesktop.pixman-0"_dep;
    cairo.Public += "pub.cppan2.demo.freetype-2"_dep;
    cairo.Public += "pub.cppan2.demo.madler.zlib-1"_dep;
    cairo.Public += "pub.cppan2.demo.png-1"_dep;
