...
{
    auto &p = s.addProject("openldap", "2.6.10");
    p += RemoteFile("https://www.openldap.org/software/download/OpenLDAP/openldap-release/openldap-{v}.tgz");
...
#define strncasecmp _strnicmp
        ...
        t.patch("include/ac/time.h",
            "#if defined(_WIN32) && !defined(HAVE_CLOCK_GETTIME)",
            "#if 0//defined(_WIN32) && !defined(HAVE_CLOCK_GETTIME)"
        );
    }
    ...
    auto add_ldap = [&lber, &s](auto &t)
    {
        ...
        t.patch("libraries/libldap/thr_posix.c",
            "#include \"portable.h\"",
            R"(
            #include  "portable.h"
