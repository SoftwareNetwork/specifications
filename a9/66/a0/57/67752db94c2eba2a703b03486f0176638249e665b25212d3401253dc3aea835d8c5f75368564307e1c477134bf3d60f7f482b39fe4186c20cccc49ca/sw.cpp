...
{
    auto &libarchive = s.addTarget<LibraryTarget>("libarchive.libarchive", "3.8.4");
    ...
    libarchive.Public += "libarchive"_id;
    if (libarchive.getBuildSettings().TargetOS.Type == OSType::Android) {
        libarchive.Public += "contrib/android/include"_id;
    }
