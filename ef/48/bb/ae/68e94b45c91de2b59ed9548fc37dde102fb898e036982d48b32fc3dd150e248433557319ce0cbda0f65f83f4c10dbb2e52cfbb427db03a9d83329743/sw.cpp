...
{
    auto &qt = s.addProject("qtproject.qt", "5.14.0");
    ...
    // base
    {
        ...
        // gui
        {
            ...
            ::rcc(rcc, gui, Files{
                                gui.SourceDir / "painting/qpdf.qrc",
                            });
        ...
        auto &windows = platforms.addTarget<LibraryTarget>("windows");
        {
            ...
            automoc(moc, windows);
            ::rcc(rcc, windows, Files{windows.SourceDir / "src/plugins/platforms/windows/cursors.qrc", windows.SourceDir / "src/plugins/platforms/windows/openglblacklists.qrc"});
