...
void build(Solution &s)
{
    ...
    auto &winflexbison = s.addProject("lexxmark.winflexbison", "2.5.25");
    ...
    auto &common = winflexbison.addTarget<StaticLibraryTarget>("common");
    {
        ...
        common -= "common/m4/lib/regex_internal.c";
        common -= "common/m4/lib/malloc/dynarray-skeleton.c";
        common -= ".*\\.def"_rr;
        common += "inline=__inline"_def;
    ...
    auto &flex = winflexbison.addTarget<FlexExecutable>("flex", "2.6.4.2");
    {
