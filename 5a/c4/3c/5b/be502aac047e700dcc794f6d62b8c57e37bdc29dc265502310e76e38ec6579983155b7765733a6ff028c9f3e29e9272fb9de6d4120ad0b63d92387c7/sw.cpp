...
auto &addBoostTarget(Solution &s, const String &name)
{
    ...
    { "array", "520d8987f7abc129f352b729e02a3915f3556b41" },
    { "asio", "6194807812b28a29d693538950e9220b283a5c9a" },
    { "assert", "3b6b826e160a122de4575d0bd0a47b26238287d7" },
    { "assign", "2d5f5f96de4a89367c73576c8ee731bcf020fb0a" },
    { "atomic", "fc410975146a23e0513e8164009cc1eac2d9830b" },
    { "beast", "b701d72ddbed3b6cd39ea038e67c8dbf2e8e4e24" },
    { "bimap", "223b2cf3a5d633c5a4f11e07ce242f51bcf61a06" },
    { "bind", "42fe00190ea2c9e0a10e699139a3a61542293543" },
    { "callable_traits", "7403f473ede40d629bc336d1ac95c14e8893e071" },
    { "chrono", "5df12496f52e00b1ea324df176a4a3199d3d8bfd" },
    ...
    { "concept_check", "b9c73e191b70eac5566f068c715f416211c9bc1e" },
    { "config", "96abc66a3b3db53b3a4f48b4a9d52e866e0e4fe0" },
    { "container", "0691018321f03aad662d7d2ae5b3e060c7109e3c" },
    { "container_hash", "9fbda1a98a32498c52a1c8ebf62311bb36a44ad4" },
    { "context", "fa50eb9d33ff8ea1bc8ab249f2272045ef6550bf" },
    { "contract", "ea151636940379a5e3996128f5f33a8c94eceb50" },
    { "conversion", "b3f8e9f014356cdc01322dd50aa9db4027656ce8" },
    { "convert", "8b6a8e4e01e9e39395945983c7038de3d2875f3e" },
    { "core", "4ea704e80a1a397c62ea01b47ed5faf6f5c699ce" },
    { "coroutine", "f6741b38876f4290d7afc40a32c825c830e58cec" },
    { "coroutine2", "8e92be839d3b2b80087289f404a7b892082513e1" },
    { "crc", "28d2df3803fbab1e3799cdfd91296f7006b8a495" },
    { "date_time", "b0437e2999a65668dc4178dbb817a89a382ece94" },
    { "detail", "7ce5543198a1b3023f10e28878b454115c064828" },
    { "disjoint_sets", "4980fe2a87ead3b2e8260aed6e9c8835266cd5d7" },
    { "dll", "8f39a38a3188a510054d86ee15bc523494676cdc" },
    { "dynamic_bitset", "91625cece1249396fc3766feffbfe11a3e0026c6" },
    { "endian", "3c6c06616d9684601a4b83577db25302d90d1570" },
    { "exception", "c87b9c55b1e4d5937b32abe2b84f249171f950ba" },
    { "fiber", "98ff5c8503a7737445421c3b41b71b900a45d63f" },
    { "filesystem", "e49775e8bbc4d8dbea5fbf6cf7c29f4d7bbd0c67" },
    ...
    { "function", "7f69508eacf80db039c0c1b343748f9f0d5ac1ac" },
    { "function_types", "ae4fde2e2ae88291d6d656137169ff4003d184a1" },
    { "functional", "7516442815900430cc9c4a6190354e11bcbe72dd" },
    { "fusion", "81a1c2c99a06d35852a3686d6d461c3290fbccd5" },
    { "geometry", "aa470306304d7ac5144d09c76d8e52a9af273ab4" },
    { "gil", "715d760be8a5a8b12bfc5e2d3600afe320236edf" },
    { "graph", "815268534fc04adf00c9f5bd6803328e20fe14c1" },
    { "graph_parallel", "6d4757c56f8d3d5bb2efa4c5d46119af305ef441" },
    { "hana", "be9878006194657fec8ca8ff1e4dccb5f6d95cc3" },
    { "headers", "" },
    { "heap", "e4b3a2ea733fcb4bb3b50f362af83e8480e016ae" },
    { "histogram", "37edc673fa5b0d6ba1e7c9b19b97a1898648ff87" },
    { "hof", "a5fcba3ae4410d217a7a80a782238bb18fa7925a" },
    { "icl", "adaf950fadf370ed4b8a33153d6510bff242ff06" },
    { "integer", "33c165552cf1f9f16720acac43ad5477d58483f7" },
    { "interprocess", "6d9b93f1f655318e459845a55e48b368177336d1" },
    { "intrusive", "f0b48ce2cfd321306efd00bd75f7ea8f45d29847" },
    { "io", "5fa66f1f76fb9142765692cc0cf6e40af8d08c45" },
    { "iostreams", "703e9a077b899417ead9fb6c35db8f03b41247b6" },
    { "iterator", "814965402e250c8ceb3883e3b2c6596e0f100f92" },
    { "lambda", "8824e81d52489be9c8cb21d8f8477b03e675ce66" },
    { "lexical_cast", "8f5bcd0f5e65a870fad290b127a29a24ecb59300" },
    ...
    { "log", "4f5e669376e0ca4d063aaf35d5682efc671525cc" },
    { "logic", "3a9110fc34ff0248062c83466fcfae0bc0a113c1" },
    { "math", "6c0ac9a8c81629dfbc38a060deb58db6e1a8871a" },
    { "metaparse", "1cb74cdbe1b989a576b0b8f7fe34151562840797" },
    { "move", "f363c21df8385c83008b1b8a91595b043fdf5398" },
    { "mp11", "a03e644dc70facf7318432ce9bb86da9009d3944" },
    { "mpi", "73cffe9b31455020386d071016e26e5af7911062" },
    { "mpl", "273db7926616f5f4d98121952d3221af6b4fc049" },
    { "msm", "fc3671a41c583aefd6b40c15673b83589e4f4220" },
    { "multi_array", "3ab14966b5633d91fbd3e3b98f60a807a0561dcb" },
    { "multi_index", "f3ed1db062983e7682573c64ece318fb9ca0626a" },
    { "multiprecision", "91bd99e98735d7bec06d31f81c9196586eef9921" },
    { "numeric", "36f969a4c5129d11a8913fcbd8d2732ba957315b" },
    { "doc", "" },
    { "interval", "802aef1264008754e03f4a6244b9ccdd88328371" },
    ...
    { "outcome", "9acf68ccf6fcc9cb8a10faf59bf7cdeff2257724" },
    { "parameter", "5d3e39325e13a74645b60af33b16e8369f5ee61d" },
    { "parameter_python", "787d8d38d9fd49c34a757b20361f8042dd5ac820" },
    { "phoenix", "99fba04b40cbd2a191382b58402472662e2ad6e1" },
    { "poly_collection", "d13e8ba7ba4e67a29eb102cb4c700776db86d4fc" },
    { "polygon", "8738898fc130a12cca349cdac60ca5d659c7cfab" },
    { "pool", "f963e6b8080fa0a8e4133c09b2559c0ac86905d5" },
    { "predef", "13de873d87fd45913ea391eb5c543fc28d65b8ad" },
    { "preprocessor", "d135cad759062ba646cb4bc40c163e590d381001" },
    { "process", "3eacae5e38aabce90b1cbc46b24a4bf5bc8c2928" },
    ...
    { "ptr_container", "601ca9d0f61c2b45498a127368e4c4d471105d70" },
    { "python", "102acf1d34ff91e67fe9aae401edc6edd68be89e" },
    { "qvm", "d0b0e774588f059d2f16aa51d2fc4068d8412710" },
    ...
    { "regex", "18e7b8c4635a5042db971e41cebd7889383ea00e" },
    { "safe_numerics", "273526b7211d22c510b890cf1d2a703b6b7836b9" },
    { "scope_exit", "3a2c1d7da44af2bb4bf47a4dc051998a80d3194f" },
    { "serialization", "f01148e421d2072294a6bc5faf70a5f6d4a709c2" },
    { "signals2", "fe476cb0a1a57d570f305ec959affedef48caac4" },
    { "smart_ptr", "4fbb9ff076279c3befaaab5c4286c0b01015c437" },
    { "sort", "62dbaee9779b6f3e84c20e66c20861ecc6d98749" },
    { "spirit", "1f81edb4fc4a63a50bc4f61e23092d98d5da4427" },
    { "stacktrace", "1ad62e582aecb656faaf0c30fcf42fca4656cfbc" },
    { "statechart", "798d77087ecc144f36f8f5873dd1e9a4f4926344" },
    { "static_assert", "233ef6bedd1868437a1c7fb7e7f77c6a1b6e3495" },
    { "system", "9b8cb7f1f674998fedcbdf85791b0d41cc8bcab4" },
    { "test", "29ecd9ed95f35671311640a66add12f621412d31" },
    { "thread", "ba02b3af428706262d3cd0436f02f616a386e750" },
    { "throw_exception", "37dfb7fe928be5918cea02a152f3f7ce08981a98" },
    { "timer", "075d6b25ab185526b0704fc9d1c982931729c35c" },
    { "tokenizer", "6665195565aebd5888d0c1aee7f416e16b26c41c" },
    ...
    { "type_index", "afd1b6cdc88c516d72a6a2f7a7dd3585f7a8f20c" },
    { "type_traits", "cbcb282722d326d90eb9c1696d06be89ba3a3acc" },
    ...
    { "utility", "f03b681d0110d0a0236c2cd2fa6cb333b6454935" },
    { "uuid", "2400f6951917cc3ad955d6850747fba48843578b" },
    { "variant", "7ecf721f2b20df142d73d0dc1fe0677abb05c9d1" },
...
void build(Solution &s)
{
    ...
    *boost_targets["container"] -= "src/dlmalloc.*\\.c"_rr;
    if (boost_targets["filesystem"]->getSettings().TargetOS.Type == OSType::Windows)
    ...
    *boost_targets["log"] +=
    ...
    if (boost_targets["regex"]->getSettings().TargetOS.Type == OSType::Windows)
...
void boost_deps(std::unordered_map<String, NativeExecutedTarget*> &boost_targets)
{
...

    {
        ...
        add_public_dependency("histogram", "callable_traits", true);
        ...
        add_public_dependency("histogram", "tti", true);
        ...
        add_public_dependency("lexical_cast", "chrono", true);
        ...
        add_public_dependency("lexical_cast", "date_time", true);
        add_public_dependency("lexical_cast", "detail", true);
        add_public_dependency("lexical_cast", "dynamic_bitset", true);
        add_public_dependency("lexical_cast", "endian", true);
        add_public_dependency("lexical_cast", "exception", true);
        add_public_dependency("lexical_cast", "filesystem", true);
        add_public_dependency("lexical_cast", "foreach", true);
        ...
        add_public_dependency("lexical_cast", "iostreams", true);
        add_public_dependency("lexical_cast", "iterator", true);
        add_public_dependency("lexical_cast", "lambda", true);
        add_public_dependency("lexical_cast", "locale", true);
        ...
        add_public_dependency("lexical_cast", "variant", true);
        ...
        add_public_dependency("math", "chrono", true);
        ...
        add_public_dependency("math", "date_time", true);
        add_public_dependency("math", "detail", true);
        add_public_dependency("math", "dynamic_bitset", true);
        add_public_dependency("math", "endian", true);
        add_public_dependency("math", "exception", true);
        add_public_dependency("math", "filesystem", true);
        add_public_dependency("math", "foreach", true);
        ...
        add_public_dependency("math", "iostreams", true);
        ...
        add_public_dependency("math", "locale", true);
        ...
        add_public_dependency("math", "variant", true);
        ...
        add_public_dependency("program_options", "chrono", true);
        ...
        add_public_dependency("program_options", "date_time", true);
        add_public_dependency("program_options", "detail", true);
        add_public_dependency("program_options", "dynamic_bitset", true);
        add_public_dependency("program_options", "endian", true);
        add_public_dependency("program_options", "exception", true);
        add_public_dependency("program_options", "filesystem", true);
        add_public_dependency("program_options", "foreach", true);
        ...
        add_public_dependency("program_options", "iostreams", true);
        ...
        add_public_dependency("program_options", "locale", true);
        ...
        add_public_dependency("program_options", "variant", true);
        ...
        add_public_dependency("xpressive", "chrono", true);
        ...
        add_public_dependency("xpressive", "date_time", true);
        add_public_dependency("xpressive", "detail", true);
        add_public_dependency("xpressive", "dynamic_bitset", true);
        add_public_dependency("xpressive", "endian", true);
        add_public_dependency("xpressive", "exception", true);
        add_public_dependency("xpressive", "filesystem", true);
        add_public_dependency("xpressive", "foreach", true);
        ...
        add_public_dependency("xpressive", "iostreams", true);
        ...
        add_public_dependency("xpressive", "locale", true);
        ...
        add_public_dependency("xpressive", "phoenix", true);
        add_public_dependency("xpressive", "pool", true);
        ...
        add_public_dependency("xpressive", "variant", true);
